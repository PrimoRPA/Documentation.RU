...
1. **Запустить процесс** ![](../../resources/process/debug/0-182.png) — при выполнении проигнорируются [точки останова](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/debug#tochka-ostanova) ![](../../resources/process/debug/6-1.png) (Breakpoint) и [пропуск элементов](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/debug#propusk-elementa) ![](../../resources/process/debug/ignore.png). Процесс выполнится быстрее, чем при отладке, но запишется меньше логов. 
2. **Отладить процесс** ![](../../resources/process/debug/1-126.png) — поддерживаются точки останова и пропуск элементов. Выводится наиболее полная информация о действиях робота. 
...
![](../../resources/process/debug/run-commands.png)
...
![](../../resources/process/debug/2-8.png)
...
![](../../resources/process/debug/console-table-or-text.png)

Фильтры DEBUG, INFO, ERROR, NETWORK и TEST отвечают за сбор сообщений с соответствующим типом. 

![](../../resources/process/debug/console-type-messages.png)

Над ними расположены кнопки:

* ![](../../resources/process/debug/3-10.png) **Следовать за наполнением консоли** — текст консоли будет всегда фокусироваться на последнем полученном сообщении.
* ![](../../resources/process/debug/4-8.png) **Очистить консоль** — очищает содержимое консоли.
...
![](../../resources/process/debug/enterp.png)
...
![](../../resources/process/debug/debug-run-to-start-element.png)
...
Пропуск элемента — это встроенный инструмент, который позволяет отключить какой-либо элемент при отладке. Чтобы установить пропуск, нажмите иконку ![](../../resources/process/debug/ignore.png) в заголовке нужного элемента: 

![](../../resources/process/debug/001.png). 

В результате элемент не будет выполнен при отладке сценария — робот его пропустит. 

### Пауза 

Начиная с версии Primo Studio RPA  1.24.4, добавлена кнопка **Пауза** для процессов типа **Последовательность**. Это позволяет останавливать выполнение процесса в нужный момент, что улучшает контроль за его исполнением.

![](../../resources/process/debug/pause.png)
...
Чтобы включить точку останова, нажмите иконку ![](../../resources/process/debug/6-1.png) в заголовке нужного элемента. Когда отладчик дойдет до элемента с точкой останова, выполнение будет приостановлено. 

Чтобы возобновить отладку, выберите на вкладке меню «Отладка» одну из команд:

* **Сделать шаг** ![](../../resources/process/debug/9-4.png) — осуществляет переход к следующему элементу, после чего процесс снова будет остановлен.
* **Возобновить процесс** ![](../../resources/process/debug/10.png) — возобновляет свободное выполнение процесса до следующей точки останова.

Для принудительного завершения процесса используйте кнопку **Остановить отладку** ![](../../resources/process/debug/11-2.png). 
...
![](../../resources/process/debug/output-panel.png)
...
![](../../resources/process/debug/output-change-value-in-context-menu.png)
...
![](../../resources/process/debug/001-18.png)

Для создания нового наблюдения нажмите кнопку **Создать наблюдение** ![](../../resources/process/debug/12-2-3-1-1-2-1-2.png). Введите текст вычисляемого выражения в появившемся окне:

![](../../resources/process/debug/15.png)

Обновить результат вычисления можно по кнопке **Обновить** ![](../../resources/process/debug/refreshwatch.png) соответствующего наблюдения. 

Для просмотра значения нажмите кнопку **Просмотр** ![](../../resources/process/debug/viewvariable.png). Выбранное значение можно скопировать комбинацией клавиш `Ctrl` + `C` либо командой контекстного меню.

Изменить вычисляемое выражение можно в ячейке таблицы либо открыв окно редактирования двойным щелчком на нужном наблюдении. Чтобы удалить наблюдение, выделите его в таблице и нажмите кнопку **Удалить наблюдение** ![](../../resources/process/debug/13-1-1-2-1-1-2-1-8.png) либо клавишу `Delete`.
