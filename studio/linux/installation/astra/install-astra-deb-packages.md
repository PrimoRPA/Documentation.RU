...
- `Browser Extensions` - набор для установки на машины, где планируется запускать оркестровых роботов (см инструкцию Настройка машины робота на Astra Linux `todo: добавить гиперссылку на документ`)
