...
| Страница                | String                                                                                                   | Наименование страницы Excel                                                                | `"List1"`    |
| Индекс страницы         | Int32                                                                                                    | Порядковый номер страницы. Если указано название страницы, это свойство можно не заполнять | `0`          |
