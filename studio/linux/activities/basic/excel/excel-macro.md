...
![](../../../resources/activities/basic/excel/wfrunmacro-fixed.png)
...
| Асинхронный    | Boolean       | Определяет, нужно ли выполнять макрос асинхронно — в этом случае робот не будет дожидаться конца выполнения макроса и перейдет к следующему элементу. <p>По умолчанию чекбокс отключен, макрос выполняется синхронно</p> |
