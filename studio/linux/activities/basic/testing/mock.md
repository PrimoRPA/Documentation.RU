...
* _Элемент_ (продуктив) - данный подпроцесс работает, если переключатель заглушки выключен ![](../../../resources/activities/basic/testing/заглушка-выкл-fixed.png). Используется для выполнения отлаженной последовательности элементов.
* _Заглушка_ (среда разработки) - данный подпроцесс работает, если переключатель заглушки включен ![](../../../resources/activities/basic/testing/заглушка,-переключатель-fixed.png). Используется для отладки последовательности.
