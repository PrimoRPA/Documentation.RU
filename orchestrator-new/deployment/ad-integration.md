...
| AdminPassword          | Зашифрованный пароль	 | См. раздел «Атрибуты безопасности» в статье ???????? «Развертывание Primo RPA 1.23.6 - Руководство администратора» (входит в комплект поставки) |
