...
| 20. | 307 | WorkerTestNotAvailable | Машина не доступна |
...
| 49. | 513 | RobotProjectCompletedError | Зафиксировано не удачное завершение выполнения проекта роботом |
...
| 150. | 40005 | AgentTestNotAvailable | Агент не доступен |
