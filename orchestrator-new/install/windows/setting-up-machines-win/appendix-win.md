...
:bangbang: **Не совместим с RDP-Disconnector. Если создан этот Windows-task, он должен быть выключен!!!**
...
Базовую\* настройку машины робота и установку Агента можно выполнить посредством PowerShell-скрипта `PrimoWorker.ps1`, который входит в комплект поставки Оркестратора. 

> \* - Дефолтный конфигурационный файл. Применим в большинстве случаев. TenantId = null
