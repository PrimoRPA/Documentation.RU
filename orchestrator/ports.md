...
Ниже представлен список сетевых портов, которые используются при настройке конфигурационных файлов компонентов Оркестратора, машин роботов и открытия портов на файерволе.
...
| 8000-9000  | TCP  | Диапазон портов, которые используют роботы. Каждый новый робот занимает следующий порт, например: первый робот - 8000, второй робот - 8001 и т.д. |
