...
Для запроса лицензии перейдите в раздел **Настройки ➝ Лицензии**. Для этого в правом верхнем углу нажмите значок *Шестеренка* ![](../resources/deployment/шестеренка.png) и выберите пункт **Лицензии**.

![](../resources/deployment/все-лицензии.-орк.png)

Далее нажмите кнопку **Запрос на лицензию**. Откроется форма создания запроса:

![](../resources/deployment/форма-создания-запроса-на-лицензию.-орк.png)
...
![](../resources/deployment/10.-форма-создания-запроса-на-лицензию-1.png)
...
![](../resources/deployment/проверка-лицензии.png)
...
![](../resources/deployment/11.-отображение-валидности-и-даты-истечения-лицензий.png) 
...
![](../resources/deployment/12.-дистрибутивы-робота.png) 
...
![](../resources/deployment/зарегистрированные-в-оркестраторе-машины-роботов.png) 
