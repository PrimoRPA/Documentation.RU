...
4. Повышена производительность активностей группы **Рабочий стол: События**, в которых выполняется частые запросы к сервису, предоставляющего состояния элементов управления рабочего стола. 
К таким событиям относятся "Событие изменение атрибута" и "Событие изменение состояния".

5. В диалог создания нового проекта добавлены шаблоны Robotic Enterprise Framework 1.2 (REFramework, REF), которые можно выбрать в выпадающем списке.
