...
7. Реализовано функционирование IntelliSense для работы с переменными и аргументами.
...
16. Устранена проблема, приводившая к нестабильной работе при запуске робота из Robot Runner по расписанию.
