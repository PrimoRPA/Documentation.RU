...
3. Реализованы активности группы **Рабочий стол: События**:
* События системы
...
7. В диалог создания нового проекта добавлены шаблоны Robotic Enterprise Framework 1.2 (REFramework, REF), которые можно выбрать в выпадающем списке.
