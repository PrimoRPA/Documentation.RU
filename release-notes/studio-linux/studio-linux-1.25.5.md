...
6. В окно лицензирования добавлена кнопка "Сохранить запрос на лицензию" и возможность изменения параметров лицензии для Студии и Robot Runner.

7. Из окна **Настройки -> Отладчик** удален чекбокс "Отображать консоль робота".
