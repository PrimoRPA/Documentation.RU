...
6. Добавлена возможность авторизации по Keycloak в Студии и Роботе при получении лицензии из Оркестратора (в дополнение к возможностям авторизации с помощью локальной учетной записи и учетной записи AD). 
При запуске из командной строки для использования данного вида авторизации необходимо указывать новый аргумент **keycloakauth**.
