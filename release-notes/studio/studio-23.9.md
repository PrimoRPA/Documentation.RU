...
1. Добавлена проверка версии Студии при авторизации в Оркестраторе. Если версия меньше допустимой, то авторизация завершится ошибкой. Ограничение на минимально допустимую версию Студии, а также тип поведения при ошибке [настраивается](https://docs.primo-rpa.ru/primo-rpa/orchestrator/deployment/fine-tuning/limit-studio-version) в конфигурационном файле Оркестратора.
